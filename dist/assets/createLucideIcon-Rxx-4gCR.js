import{r as a,j as f,v as w,w as h}from"./index-v7imGIq4.js";var v=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],A=v.reduce((t,e)=>{const r=w(`Primitive.${e}`),o=a.forwardRef((i,s)=>{const{asChild:c,...n}=i,l=c?r:e;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),f.jsx(l,{...n,ref:s})});return o.displayName=`Primitive.${e}`,{...t,[e]:o}},{});function P(t,e){t&&h.flushSync(()=>t.dispatchEvent(e))}/**
